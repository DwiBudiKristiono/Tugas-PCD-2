...
plt.figure('Histogram Equalization')    #menampilkan gambar Histogram Equalization
plt.subplot(2,1,1),plt.hist(gray.ravel(),300,[0,256]),plt.title('Histogram awal')   #menampilkan gambar asli
plt.subplot(2,1,2),plt.hist(equ.ravel(),256,[0,256]),plt.title('Histogram hasil equalization')  #menampilkan gambar Histogram hasil equalization
plt.show()
